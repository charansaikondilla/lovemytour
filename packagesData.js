...
export const continentsData = {
  "asia": {
    ...
    destinations: [
      ...
      // South Asia
      { id: "india", name: "India", tag: "Golden Triangle", image: "https://images.unsplash.com/photo-1570206986634-afd7cccb68d3?auto=format&fit=crop&w=800&q=80", packagesCount: 3, desc: "Taj Mahal, Jaipur & Rajasthan Forts" },
      { id: "nepal", name: "Nepal", tag: "Himalayan Peaks", image: "https://images.unsplash.com/photo-1574007768454-75b5d20f6454?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Everest Base Camp & Kathmandu Temples" },
      { id: "bhutan", name: "Bhutan", tag: "Mountain Monasteries", image: "https://images.unsplash.com/photo-1578556881786-851d4b79cb73?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Tiger's Nest Monastery & Paro Valley" },
      { id: "pakistan", name: "Pakistan", tag: "Alpine Valleys", image: "https://images.unsplash.com/photo-1514558427911-8e293bebf18c?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Hunza Valley & Karakoram Peaks" },
      { id: "bangladesh", name: "Bangladesh", tag: "Mangrove Wilderness", image: "https://images.unsplash.com/photo-1549300461-11c5b94e8855?auto=format&fit=crop&w=800&q=80", packagesCount: 1, desc: "Sundarbans Mangroves & Royal Bengal Tigers" },
      { id: "afghanistan", name: "Afghanistan", tag: "Historic Highlands", image: "https://images.unsplash.com/photo-1637750832829-7cc7e0605c15?auto=format&fit=crop&w=800&q=80", packagesCount: 1, desc: "Bamiyan Valley & Ancient Silk Road Sites" },
      // Southeast Asia
      { id: "philippines", name: "Philippines", tag: "Islands & Lagoons", image: "https://images.unsplash.com/photo-1695051702427-1c24ce3682e7?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "El Nido Lagoons & Chocolate Hills" },
      { id: "myanmar", name: "Myanmar", tag: "Ancient Temple Plains", image: "https://images.unsplash.com/photo-1702226580087-a416fe3e145a?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Bagan's 4,000 Ancient Pagodas" },
      { id: "cambodia", name: "Cambodia", tag: "Ancient Khmer Temples", image: "https://images.unsplash.com/photo-1565687363630-7a81809a199c?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Angkor Wat & Siem Reap Temples" },
      { id: "laos", name: "Laos", tag: "Waterfalls & Temples", image: "https://images.unsplash.com/photo-1593994603100-9cd7cb22aaf1?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Kuang Si Falls & Luang Prabang" },
      { id: "brunei", name: "Brunei", tag: "Water Village & Rainforest", image: "https://images.unsplash.com/photo-1705583855040-3c25b4a9eab9?auto=format&fit=crop&w=800&q=80", packagesCount: 1, desc: "Kampong Ayer & Ulu Temburong" },
      { id: "timor-leste", name: "Timor-Leste", tag: "Cristo Rei & Coastline", image: "https://upload.wikimedia.org/wikipedia/commons/1/10/Cristo_Rei_of_Dili%2C_Timor-Leste.jpg", packagesCount: 1, desc: "Cristo Rei Statue & Dili Coastline" },
      // East Asia
      { id: "china", name: "China", tag: "Ancient Wonders", image: "https://images.unsplash.com/photo-1693721783596-afebf1d4354f?auto=format&fit=crop&w=800&q=80", packagesCount: 1, desc: "Great Wall, Beijing & Terracotta Army" },
      { id: "south-korea", name: "South Korea", tag: "Palaces & Neon Cities", image: "https://images.unsplash.com/photo-1566800890932-e89159daf3dc?auto=format&fit=crop&w=800&q=80", packagesCount: 1, desc: "Gyeongbokgung Palace & Seoul Skyline" },
      { id: "north-korea", name: "North Korea", tag: "Isolated Capital", image: "https://images.unsplash.com/photo-1604359896927-0610b7a3a2be?auto=format&fit=crop&w=800&q=80", packagesCount: 1, desc: "Pyongyang Skyline & Juche Tower" },
      { id: "mongolia", name: "Mongolia", tag: "Steppe & Nomad Culture", image: "https://images.unsplash.com/photo-1708873395735-dcad0140e3a2?auto=format&fit=crop&w=800&q=80", packagesCount: 1, desc: "Genghis Khan Statue & Gobi Desert" },
      // Central Asia
      { id: "kazakhstan", name: "Kazakhstan", tag: "Alpine Frontier", image: "https://images.unsplash.com/photo-1659651117607-d2b397cf100f?auto=format&fit=crop&w=800&q=80", packagesCount: 1, desc: "Almaty & the Tien Shan Mountains" },
      { id: "uzbekistan", name: "Uzbekistan", tag: "Silk Road Heritage", image: "https://images.unsplash.com/photo-1664602078796-68ee76b3fc59?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Registan Square & Samarkand Mosaics" },
      { id: "turkmenistan", name: "Turkmenistan", tag: "Marble City Architecture", image: "https://images.unsplash.com/photo-1530381668793-2c03a6dd3698?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Ashgabat's White Marble Skyline" },
      { id: "kyrgyzstan", name: "Kyrgyzstan", tag: "Alpine Silk Road", image: "https://images.unsplash.com/photo-1610720684893-619cd7a5cde5?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Tian Shan Peaks & Issyk-Kul Lake" },
      { id: "tajikistan", name: "Tajikistan", tag: "Pamir Mountain Valleys", image: "https://images.unsplash.com/photo-1585649640892-f97f19f45724?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Pamir Highway & Fann Mountains" },
      // West Asia / Middle East
      { id: "saudi-arabia", name: "Saudi Arabia", tag: "Desert Heritage & AlUla", image: "https://images.unsplash.com/photo-1609151712779-4f86b3de7308?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "AlUla Rock Canyons & Hegra Tombs" },
      { id: "qatar", name: "Qatar", tag: "Skyline & Corniche", image: "https://images.unsplash.com/photo-1575363093009-925e54c9bbe1?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Doha Skyline & Traditional Dhows" },
      { id: "kuwait", name: "Kuwait", tag: "Iconic Kuwait Towers", image: "https://images.unsplash.com/photo-1567074994308-df304d5611db?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Kuwait Towers & Arabian Gulf Corniche" },
      { id: "bahrain", name: "Bahrain", tag: "Manama Sunset Skyline", image: "https://images.unsplash.com/photo-1748066768504-99532da7d1e9?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Bahrain World Trade Center & Manama" },
      { id: "oman", name: "Oman", tag: "Desert & Heritage", image: "https://images.unsplash.com/photo-1715890545305-b6927eeea369?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Sultan Qaboos Grand Mosque & Wahiba Sands" },
      { id: "yemen", name: "Yemen", tag: "Ancient Architecture", image: "https://upload.wikimedia.org/wikipedia/commons/5/5c/San%27a03_flickr.jpg", packagesCount: 1, desc: "Old City of Sana'a's Historic Tower Houses" },
      { id: "iraq", name: "Iraq", tag: "Mesopotamian Heritage", image: "https://upload.wikimedia.org/wikipedia/commons/6/6b/Ziggarat_of_Ur_001.jpg", packagesCount: 1, desc: "Ziggurat of Ur & Ancient Mesopotamia" },
      { id: "iran", name: "Iran", tag: "Persian Heritage", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ee/Naqsh-i_Jahan_Square%2C_Jan._2018.jpg/1280px-Naqsh-i_Jahan_Square%2C_Jan._2018.jpg", packagesCount: 2, desc: "Naqsh-e Jahan Square & Isfahan's Historic Sites" },
      { id: "jordan", name: "Jordan", tag: "Petra & the Dead Sea", image: "https://images.unsplash.com/photo-1551171129-8ce1ebb911b3?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Petra's Treasury & the Dead Sea" },
      { id: "israel", name: "Israel", tag: "Historic & Holy Sites", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Temple_Mount_%28Aerial_view%2C_2007%29_07.jpg/1280px-Temple_Mount_%28Aerial_view%2C_2007%29_07.jpg", packagesCount: 2, desc: "Jerusalem's Old City & the Sea of Galilee" },
      { id: "lebanon", name: "Lebanon", tag: "Mediterranean Heritage", image: "https://upload.wikimedia.org/wikipedia/commons/e/ea/Beyrouth_vue_a%C3%A9rienne.jpg", packagesCount: 2, desc: "Beirut's Corniche & Baalbek Ruins" },
      { id: "syria", name: "Syria", tag: "Ancient Civilizations", image: "https://upload.wikimedia.org/wikipedia/commons/c/c1/Palmyra_03.jpg", packagesCount: 1, desc: "Palmyra's Ancient Ruins & Desert Oasis" },
      { id: "cyprus", name: "Cyprus", tag: "Mediterranean Beaches", image: "https://images.unsplash.com/photo-1524907312580-7389c74dbf19?auto=format&fit=crop&w=800&q=80", packagesCount: 2, desc: "Aphrodite's Rock & Paphos Coastline" },
      { id: "palestine", name: "Palestine", tag: "Historic & Holy Sites", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/61/Church_of_the_Nativity_%287703592746%29.jpg/1280px-Church_of_the_Nativity_%287703592746%29.jpg", packagesCount: 1, desc: "Bethlehem's Church of the Nativity" }
    ]
  },
  "africa": {
    id: "africa",
...
export const DESTINATION_CATEGORIES = {
  ...
  bhutan: ["mountains"],
  pakistan: ["mountains"],
  bangladesh: ["tropical-forest", "safari-wildlife"],
  afghanistan: ["mountains"],
  philippines: ["islands", "beach"],
  myanmar: [],
  cambodia: [],
  laos: ["tropical-forest"],
